...
const projects = [
  { num: '01', title: 'Employer Branding, Image- & Eventfilm', category: 'Video & Film', year: '2025', color: '#1C1C1C', desc: 'Unternehmensfilm von A bis Z.', video: '/images/projects/projekt-1.webm', image: '', href: '/projects/video' },
  { num: '02', title: 'Explainer & Motion Graphics', category: 'Animation', year: '2025', color: '#2A1F1A', desc: 'Logoanimation & Motion-Set.', video: '/images/projects/projekt-2.webm', image: '', href: '/projects/motion' },
  { num: '03', title: 'Social', category: 'Social Media', year: '2024', color: '#1A1F2A', desc: 'Content-Strategie & Produktion.', video: '', image: '', href: '/projects/social' },
