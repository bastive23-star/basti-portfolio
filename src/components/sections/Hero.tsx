...
export default function Hero() {
  ...
  return (
    <>
      ...
      {/* Outer section is tall — gives scroll room so video scrubs slowly */}
      <section ref={sectionRef} style={{ height: '220dvh' }}>
      ...
      >
        ...
        >
          <video ref={videoRef} src="/images/hero-bg.mp4" muted playsInline preload="auto"
